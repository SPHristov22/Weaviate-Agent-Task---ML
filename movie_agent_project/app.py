...
# Allows running with `python app.py` by relaunching under `streamlit run`.
...
DEMO_QUERIES = [
    ("1. Simple Search", "Find me a sci-fi movie about space anomalies."),
    ("2. Multi-collection Query", "Find me a sci-fi movie and also show me its reviews."),
    ("3. Follow-up Question", "What is the release year of the space movie you just mentioned?"),
    ("4. Filtering / Aggregating", "Find action movies released before 2010 with a rating above 8.5."),
    ("5. Free-form formulation", "I'm in the mood for something nostalgic and slightly scary but no jump scares."),
]
...
if "demo_query" in st.session_state:
    # Consume the queued demo query and clear it to avoid replay on next rerun.
